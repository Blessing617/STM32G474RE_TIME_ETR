...
uint32_t CNT_1 = 0; // 0-4294967295内用这个记录
uint32_t CNT_2 = 0; // 超出4294967295位后 用这个记录超过的次数
/* USER CODE END 0 */
...
int main(void)
{
  ...
  OLED_CLS();
  OLED_ShowCN(0, 0, 4);                     // 频
  OLED_ShowCN(16, 0, 5);                    // 率
  OLED_ShowStr(100, 2, (uint8_t *)"Hz", 2); // 单位
